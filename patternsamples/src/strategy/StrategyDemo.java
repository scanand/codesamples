 ...
 * 
 * http://www.vincehuston.org/dp/StrategyDemosJava
 * Testing comments
 */
// 2. Bury implementation
abstract class TemplateMethod1 implements StrategyDemoInf { // 3. Template Method
	public void solve() {
		start();
...
// 2. Bury implementation
abstract class TemplateMethod2 implements StrategyDemoInf { // 3. Template Method
	public void solve() {
		while (true) {
			preProcess();
			if (search())
...
public class StrategyDemo {
	public static void clientCode(StrategyDemoInf strat) {
		strat.solve();
	}

	public static void main(String[] args) {
		StrategyDemoInf[] algorithms = { new Impl1(), new Impl2() };
